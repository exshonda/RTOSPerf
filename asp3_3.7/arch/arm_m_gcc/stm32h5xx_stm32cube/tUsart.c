...
{
	return (sil_rew_mem((void*)USART_ISR(ATTR_baseAddress)) & USART_ISR_RXNE_RXFNE) != 0;
}
...
{
	return (sil_rew_mem((void*)USART_ISR(ATTR_baseAddress)) & USART_ISR_TXE_TXFNF) != 0;
}
...
eSIOPort_open(CELLIDX idx)
{
    ...
    sil_wrw_mem((void*)USART_PRESC(ATTR_baseAddress), 0);
